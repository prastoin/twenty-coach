...
export default defineView({
  ...
  fields: [
    ...
    { universalIdentifier: 'd22eb3ce-a5da-49c5-9071-7f0c92ca627c', fieldMetadataUniversalIdentifier: PROGRAM_EXERCISE_ORDER_FIELD_UNIVERSAL_IDENTIFIER, position: 4, isVisible: true },
    ...
    { universalIdentifier: 'ca9232f0-d3bb-4615-8d45-d227f3499b12', fieldMetadataUniversalIdentifier: PROGRAM_EXERCISE_TARGET_RIR_FIELD_UNIVERSAL_IDENTIFIER, position: 8, isVisible: true },
    { universalIdentifier: '87a56953-fef4-46ec-9939-16bc87e63655', fieldMetadataUniversalIdentifier: PROGRAM_EXERCISE_REST_SECONDS_FIELD_UNIVERSAL_IDENTIFIER, position: 9, isVisible: true },
    { universalIdentifier: '510026df-e456-4cba-8c4d-19529bdedaa1', fieldMetadataUniversalIdentifier: PROGRAM_EXERCISE_TEMPO_FIELD_UNIVERSAL_IDENTIFIER, position: 10, isVisible: true },
    { universalIdentifier: 'cae52ab0-022d-425c-9cbf-21522f79a1a5', fieldMetadataUniversalIdentifier: PROGRAM_EXERCISE_NOTES_FIELD_UNIVERSAL_IDENTIFIER, position: 11, isVisible: true },
    { universalIdentifier: 'd18a203e-27d1-496c-85e5-46e1ed40df34', fieldMetadataUniversalIdentifier: SET_LOGS_ON_PROGRAM_EXERCISE_ID, position: 12, isVisible: true },
  ],
});
