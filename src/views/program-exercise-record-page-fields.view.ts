...
export default defineView({
  ...
  fields: [
    ...
    { universalIdentifier: '2ad30ba1-5c03-4ada-a845-ab734cbd999c', fieldMetadataUniversalIdentifier: PROGRAM_EXERCISE_TARGET_SETS_FIELD_UNIVERSAL_IDENTIFIER, position: 6, isVisible: true },
    { universalIdentifier: '3d12bbf2-cb9c-41a9-9b11-01ae8c3a01a3', fieldMetadataUniversalIdentifier: PROGRAM_EXERCISE_TARGET_REPS_MIN_FIELD_UNIVERSAL_IDENTIFIER, position: 7, isVisible: true },
    { universalIdentifier: '7f78ee9e-f5da-4c7a-8ef3-3c1578e22545', fieldMetadataUniversalIdentifier: PROGRAM_EXERCISE_TARGET_REPS_MAX_FIELD_UNIVERSAL_IDENTIFIER, position: 8, isVisible: true },
    { universalIdentifier: '90ab4535-5dab-4a0f-a900-8b1e0fb0db2f', fieldMetadataUniversalIdentifier: PROGRAM_EXERCISE_TARGET_WEIGHT_KG_FIELD_UNIVERSAL_IDENTIFIER, position: 9, isVisible: true },
